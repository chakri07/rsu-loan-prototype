          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-primary/10 border border-primary/20">
                <span className="text-primary font-bold text-lg">10% APR</span>
                <span className="text-muted-foreground text-sm">rates as low as</span>
              </div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-secondary border border-border/50">
                <Shield className="w-4 h-4 text-primary" />
                <span className="text-sm text-foreground">Tax-advantaged borrowing saves you money</span>
              </div>
            </div>
